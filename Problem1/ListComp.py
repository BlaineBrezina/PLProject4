def main():
    ...
    for department in sorted({d[9] for d in s_emp[1::]}):
        print (department, (lambda x: round(sum(x) / len(x), 2))(map(float, [e[7] for e in s_emp[1::] if department == e[9]])))
    ...
    for department in sorted({d[9] for d in s_emp[1::]}):
        print (lambda x, y: (x, y) if y > 1500 else '')(department, (lambda x: round(sum(x) / len(x), 2))(map(float, [e[7] for e in s_emp[1::] if department == e[9]])))
